...
stl_disjoint_tasks = {
    ...
    "No_Beard:Wearing_Lipstick": [(96.05, (95.9, 96.21)), (20.0, (0.0, 40.24)), (94.65, (94.47, 94.83)), (0.0, (0.0, 0.0))],
...
def avg_gain_over_stl(stl_dict, mtl_dict, use_group_val_labels=True, relative_gain=False):
    avg_acc_gain = 0
...
def make_gain_over_stl_plot(use_group_val_labels=True, relative_gain=False):
    nondisjoint_gains = avg_gain_over_stl(stl_nondisjoint_tasks, mtl_nondisjoint_tasks, use_group_val_labels, relative_gain)
    disjoint_gains = avg_gain_over_stl(stl_disjoint_tasks, mtl_disjoint_tasks, use_group_val_labels, relative_gain)

    gains_data = [
        [disjoint_gains[0], disjoint_gains[1], 'Average Acc', 'Disjoint Pairings'],
        [disjoint_gains[2], disjoint_gains[3], 'Worst Group Acc', 'Disjoint Pairings'],
        [nondisjoint_gains[0], nondisjoint_gains[1], 'Average Acc', 'Nondisjoint Pairings'],
        [nondisjoint_gains[2], nondisjoint_gains[3], 'Worst Group Acc', 'Nondisjoint Pairings']
    ]
    ...
    os.makedirs(os.path.join("./plots", "disjoint_vs_nondisjoint"), exist_ok=True)
    plt.savefig(
        f"./plots/disjoint_vs_nondisjoint/stl_gain_group_val_labels_{str(use_group_val_labels)}_relative_gain_{str(relative_gain)}.png"
    )
    plt.close()
...
def make_avg_in_pairing_plot(use_group_val_labels=True):
    ...
    os.makedirs(os.path.join("./plots", "disjoint_vs_nondisjoint"), exist_ok=True)
    plt.savefig(f"./plots/disjoint_vs_nondisjoint/avg_across_pairings_group_val_labels_{str(use_group_val_labels)}.png")
    plt.close()
