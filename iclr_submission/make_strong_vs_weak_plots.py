...
stl_strong_spur_corr_tasks = {
    ...
    "Attractive:Male": [(82.18, (81.87, 82.48)), (66.11, (65.21, 67.02)), (79.76, (79.44, 80.08)), (65.62, (64.39, 66.85))],
    "Attractive:Gray_Hair": [(82.2, (81.9, 82.51)), (38.69, (25.76, 51.63)), (80.67, (80.35, 80.98)), (50.0, (36.72, 63.28))],
    "Big_Nose:Gray_Hair": [(84.0, (83.71, 84.29)), (53.86, (52.77, 54.95)), (80.52, (80.21, 80.84)), (56.93, (55.48, 58.39))],
...
stl_weak_spur_corr_tasks["Bags_Under_Eyes:Double_Chin"] = [
...
mtl_weak_spur_corr_tasks["Pairing_1"] = {
    "Bags_Under_Eyes:Double_Chin":
        [(85.62, (85.34, 85.9)), (56.75, (55.81, 57.7)), (82.14, (81.84, 82.45)), (63.36, (62.26, 64.46))],
    "High_Cheekbones:Rosy_Cheeks":
        [(87.86, (87.6, 88.12)), (70.5, (64.74, 76.26)), (85.58, (85.3, 85.86)), (72.12, (66.47, 77.76))]
}
...
mtl_weak_spur_corr_tasks["Pairing_5"] = {
    "High_Cheekbones:Rosy_Cheeks":
        [(87.82, (87.56, 88.08)), (71.27, (65.55, 76.99)), (86.29, (86.02, 86.57)), (77.59, (72.32, 82.86))],
    "Brown_Hair:Wearing_Hat":
        [(88.97, (88.71, 89.22)), (18.83, (10.18, 27.48)), (84.98, (84.69, 85.27)), (54.22, (43.32, 65.12))]
}
...
mtl_strong_spur_corr_tasks["Pairing_4"] = {
    "Wearing_Lipstick:Male":
        [(94.03, (93.84, 94.22)), (36.72, (28.78, 44.65)), (93.52, (93.32, 93.72)), (42.38, (34.27, 50.49))],
    "High_Cheekbones:Smiling":
        [(87.92, (87.66, 88.18)), (37.33, (35.88, 38.77)), (84.96, (84.67, 85.24)), (48.03, (46.66, 49.41))]
}
...
def avg_gain_over_stl(
    stl_dict,
    mtl_dict,
    use_group_val_labels=True,
    use_pairings=["Pairing_1", "Pairing_2", "Pairing_3", "Pairing_4", "Pairing_5"],
    relative_gain=False
):
    avg_acc_gain = 0
...
def make_gain_over_stl_plot(use_group_val_labels=True, pairings_to_use=None, relative_gain=False):
    ...
    weak_spur_corr_gains = avg_gain_over_stl(
        stl_weak_spur_corr_tasks, mtl_weak_spur_corr_tasks, use_group_val_labels, weak_pairings, relative_gain
    )
    strong_spur_corr_gains = avg_gain_over_stl(
        stl_strong_spur_corr_tasks, mtl_strong_spur_corr_tasks, use_group_val_labels, strong_pairings, relative_gain
    )

    gains_data = [
        [strong_spur_corr_gains[0], strong_spur_corr_gains[1], 'Average Acc', 'Strong Pairings'],
        [strong_spur_corr_gains[2], strong_spur_corr_gains[3], 'Worst Group Acc', 'Strong Pairings'],
        [weak_spur_corr_gains[0], weak_spur_corr_gains[1], 'Average Acc', 'Weak Pairings'],
        [weak_spur_corr_gains[2], weak_spur_corr_gains[3], 'Worst Group Acc', 'Weak Pairings']
    ]
    ...
    sns.barplot(x='MTL Pairing Type', y=y_label, hue='Metric', data=gains_df)
    ...
    plt.errorbar(x=x, y=gains_df[y_label], yerr=gains_df['SE'], fmt='none', c='black', capsize=2)
    ...
    if pairings_to_use is None:
        ...
        plt.savefig(
            f"./plots/strong_vs_weak/stl_gain_group_val_labels_{str(use_group_val_labels)}_relative_gain_{str(relative_gain)}.png"
        )
    else:
        plt.title(f"MTL when using Strong vs Weak Pairings for {pairings_to_use} [{ckpt_type} Ckpt]")
        plt.savefig(
            f"./plots/strong_vs_weak/stl_gain_{pairings_to_use.lower()}_group_val_labels_{str(use_group_val_labels)}_relative_gain_{str(relative_gain)}.png"
        )
...
def make_avg_in_pairing_plot(use_group_val_labels=True):
    ...
    strong_spur_corr_gains = wg_average_in_pairings(
        stl_strong_spur_corr_tasks, mtl_strong_spur_corr_tasks, use_group_val_labels
    )
    ...
    avg_pairing_df = pd.DataFrame(
        avg_pairing_data, columns=['Avg Worst Group Accuracy', "Worst Group SE", 'Learning Type', 'Pairing Number']
    )

    sns.barplot(x='Pairing Number', y='Avg Worst Group Accuracy', hue='Learning Type', data=avg_pairing_df)
    ...
    plt.errorbar(
        x=x,
        y=avg_pairing_df['Avg Worst Group Accuracy'],
        yerr=avg_pairing_df['Worst Group SE'],
        fmt='none',
        c='black',
        capsize=2
    )
