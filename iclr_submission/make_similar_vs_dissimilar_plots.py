...
stl_similar_tasks = {
    ...
    "Big_Lips:Goatee": [(70.02, (69.66, 70.39)), (11.43, (10.97, 11.89)), (70.15, (69.78, 70.52)), (39.65, (38.94, 40.35))],
...
mtl_dissimilar_tasks["Pairing_3"] = {
    ...
    "Brown_Hair:Wearing_Hat":
        [(88.96, (88.71, 89.21)), (18.83, (10.18, 27.48)), (82.91, (82.61, 83.21)), (51.52, (40.71, 62.33))]
}
...
mtl_similar_tasks["Pairing_2"] = {
    "Big_Nose:Wearing_Lipstick":
        [(84.27, (83.98, 84.56)), (34.52, (32.88, 36.17)), (76.76, (76.42, 77.1)), (62.33, (61.3, 63.36))],
    "High_Cheekbones:Smiling":
        [(87.68, (87.42, 87.95)), (38.16, (36.71, 39.62)), (84.74, (84.45, 85.03)), (51.32, (49.94, 52.7))]
}

mtl_similar_tasks["Pairing_3"] = {
    "Big_Lips:Goatee": [(70.56, (70.19, 70.92)), (12.48, (12.0, 12.95)), (68.51, (68.14, 68.88)), (49.48, (48.76, 50.2))],
    "Wearing_Lipstick:Male":
        [(93.75, (93.55, 93.94)), (38.71, (30.72, 46.7)), (93.42, (93.23, 93.62)), (49.65, (41.41, 57.89))]
}
...
mtl_similar_tasks["Pairing_5"] = {
    "Blond_Hair:Wearing_Hat": [
        (95.94, (95.78, 96.1)), (35.71, (20.72, 50.71)), (95.17, (95.0, 95.34)), (45.6, (30.49, 60.71))
    ],
    "Brown_Hair:Wearing_Hat":
        [(88.81, (88.55, 89.06)), (21.68, (12.54, 30.81)), (85.68, (85.4, 85.96)), (47.43, (36.36, 58.5))]
}
...
def make_gain_over_stl_plot(use_group_val_labels=True, pairings_to_use=None, relative_gain=False):
    ...
    dissimilar_gains = avg_gain_over_stl(
        stl_dissimilar_tasks, mtl_dissimilar_tasks, use_group_val_labels, dissimilar_pairings, relative_gain
    )
    similar_gains = avg_gain_over_stl(
        stl_similar_tasks, mtl_similar_tasks, use_group_val_labels, similar_pairings, relative_gain
    )

    gains_data = [
        [similar_gains[0], similar_gains[1], 'Average Acc', 'Similar Pairings'],
        [similar_gains[2], similar_gains[3], 'Worst Group Acc', 'Similar Pairings'],
        [dissimilar_gains[0], dissimilar_gains[1], 'Average Acc', 'Dissimilar Pairings'],
        [dissimilar_gains[2], dissimilar_gains[3], 'Worst Group Acc', 'Dissimilar Pairings']
    ]
    ...
    if pairings_to_use is None:
        ...
        plt.savefig(
            f"./plots/similar_vs_dissimilar/stl_gain_group_val_labels_{str(use_group_val_labels)}_relative_gain_{str(relative_gain)}.png"
        )
    else:
        plt.title(f"MTL when using Similar vs Dissimilar Pairings for {pairings_to_use} [{ckpt_type} Ckpt]")
        plt.savefig(
            f"./plots/similar_vs_dissimilar/stl_gain_{pairings_to_use.lower()}_group_val_labels_{str(use_group_val_labels)}_relative_gain_{str(relative_gain)}.png"
        )
    plt.close()
