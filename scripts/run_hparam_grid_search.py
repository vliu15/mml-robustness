        ...
        for wd in WD_GRID:
            for lr in LR_GRID:
                for batch_size in BATCH_SIZE_GRID:
                    ...
                    if job_name not in ["task:Blond_Hair:Male,wd:0.01,lr:1e-05,batch_size:8", "task:Blond_Hair:Male,wd:0.01,lr:1e-05,batch_size:32",
                                        "task:Blond_Hair:Male,wd:0.01,lr:1e-05,batch_size:64", "task:Blond_Hair:Male,wd:0.01,lr:0.0001,batch_size:8"]:
                        log_file = os.path.join(args.slurm_logs, f"{job_name}.log")
                        command = (
...
def main():
    ...
    submit_suby_blond_tuning_jobs(args)
