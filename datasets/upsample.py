...
class UpsampledDataset(Dataset):
    ...
    Args:
        ...
        upsample_pkl: path to pickle of indices of examples in the original dataset that should be upsampled
    """
    ...
    def __getitem__(self, index):
        ...
        up_index = (index - len(self.dataset)) % len(self.upsample_indices)
        up_index = self.upsample_indices[up_index]
